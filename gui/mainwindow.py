...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.localFilesListView = FileListView(self.verticalLayoutWidget_2, is_local=True)
                        #QtWidgets.QListView(self.verticalLayoutWidget_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.localFilesListView.sizePolicy().hasHeightForWidth())
        self.localFilesListView.setSizePolicy(sizePolicy)
        self.localFilesListView.setMinimumSize(QtCore.QSize(100, 0))
        self.localFilesListView.setMaximumSize(QtCore.QSize(16777215, 16777215))
        self.localFilesListView.setEditTriggers(QtWidgets.QAbstractItemView.NoEditTriggers)
        self.localFilesListView.setSelectionMode(QtWidgets.QAbstractItemView.ExtendedSelection)
        self.localFilesListView.setObjectName("localFilesListView")
        self.verticalLayout_2.addWidget(self.localFilesListView)
        ...
        self.mcuFilesListView = FileListView(self.verticalLayoutWidget, is_local=False)
                        # QtWidgets.QListView(self.verticalLayoutWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.mcuFilesListView.setMinimumSize(QtCore.QSize(100, 0))
        ...
        self.mcuFilesListView.setEditTriggers(QtWidgets.QAbstractItemView.SelectedClicked)
...
from src.gui.controls.file_list_view import FileListView
