...
a.datas += [('icons//main.png','icons//main.png','DATA'),
			...
			('icons//up_folder.png','icons//up_folder.png','DATA'),
			('icons//root_folder.png','icons//root_folder.png','DATA'),
			('icons//tree_file.png','icons//tree_file.png','DATA'),
			('icons//tree_folder.png','icons//tree_folder.png','DATA'),
			('icons//tree_python.png','icons//tree_python.png','DATA'),
